...
from app.agents.retrieval_router import Intent, classify_intent

logger = logging.getLogger(__name__)

_VALID = frozenset({"recall", "knowledge", "skill", "profile", "chitchat"})
...
async def classify_intent_llm(
    ...
    from app.agents.retrieval_router import classify_intent as regex_intent
